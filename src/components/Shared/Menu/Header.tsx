'use client';
import { Contact,  Kanban,  Menu } from 'lucide-react';
...
const Navbar: FC<NavbarProps> = ({}) => {
    ...
    return (
       ...
       <nav className="flex sticky mb-4 gap-x-2 shadow-md bg-body top-0 z-20 p-5  justify-between">
         <div className=''>
         <div className='flex items-center cursor-pointer hover:opacity-80  text-neutral-100 font-extrabold text-md sm:text-2xl' onClick={() => router.push('/')} >
